            ...
            <div className="sm:w-1/3 text-white flex flex-col w-full bg-gray-950 h-screen items-center justify-center p-4">
                ...
                <div className="w-[80%] flex flex-col">
                    ...
                    <div className="flex flex-col mb-2">
                        ...
                        <input className="w-full text-sm text-gray-700 p-3 bg-white focus:outline-blue-400 rounded-sm" type="password" placeholder="Digite a sua senha"></input>
                    </div>

                    <button className="bg-blue-500 hover:bg-blue-700 font-semibold py-2 px-4 mt-6 mb-2 rounded-sm cursor-pointer">Login</button>
