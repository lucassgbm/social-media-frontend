...
export default function Toaster(props: any){
    return (
        <div className="flex flex-row fixed bottom-4 right-4 bg-white dark:bg-neutral-600 dark:text-white w-[auto] min-w-[280px] h-[auto] text-sm font-semibold p-2 rounded-sm shadow-md items-center">
